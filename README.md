...
Once the server is running, open your browser and navigate to `http://localhost:3033/`. The application will automatically reload whenever you modify any of the source files.
...
```bash
git clone https://github.com/actionanand/flowra.git --branch 1-skeleton new-proj-name
```

```bash
npx degit github:actionanand/flowra#1-skeleton new-proj-name
```

```bash
npx gitpick https://github.com/actionanand/flowra -b 1-skeleton
```
