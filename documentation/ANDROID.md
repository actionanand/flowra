...
Flowra shows an explanatory prompt before Android's notification permission dialog. Enabled reminders are rebuilt on startup and after backup restoration. Each profile has one stable notification ID; changing its reminder offset cancels and replaces the previous schedule.
